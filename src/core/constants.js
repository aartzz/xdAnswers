...
КРИТИЧНО: НЕ пиши жодних роздумів, ланцюжків думок чи вступів (ніяких "The user asks...", "Here's a thinking process", "I need to select...", "<think>" тощо). Одразу виводь результат у форматі полів!
