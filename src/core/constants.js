...
- Якщо питання має список варіантів відповідей, у полі answer ОБОВ'ЯЗКОВО вкажи текст вибраного варіанту З ЦЬОГО СПИСКУ. Ніколи не відповідай "Правда" або "Неправда", якщо ці слова не входять до списку варіантів.
