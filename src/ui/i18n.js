(function() {
    ...
    const TRANSLATIONS = {
        uk: {
            ...
            tabFeatures: 'Налаштування',
            tabThemes: 'Теми',
            settingsSearchPlaceholder: 'Шукати в налаштуваннях',
            sectionGeneral: 'Загальні',
            sectionGeneralDesc: 'Мова, гарячі клавіші, розташування',
            sectionAutomation: 'Автоматизація й відповіді',
            sectionAutomationDesc: 'Автовідповідь, підсвічування, обмеження',
            sectionAiTools: 'Інструменти ШІ',
            sectionAiToolsDesc: 'Веб-пошук, калькулятор LaTeX',
            sectionStealth: 'Режим непомітності',
            sectionStealthDesc: 'Тихий режим, індикатори, стелс',
            sectionAppearance: 'Оформлення й стиль',
            sectionAppearanceDesc: 'Кольори, теми, система дизайну',
            ...
            badgeMultimodal: 'Мультимодальна',
            badgeLongContext: 'Довгий контекст',
            badgeAgentic: 'Агентна',
            badgeAudio: 'Аудіо ввід',
            badgeStructured: 'Структурований вивід',
            badgeWebSearch: 'Веб-пошук',
            badgeMaxTokens: 'Макс. токенів',
            badgeCostInput: 'Ввід',
            ...
            webSearchHint: 'Дозволити ШІ шукати в інтернеті актуальну інформацію. Потрібен пошуковий провайдер у вкладці Провайдери (SearXNG безкоштовно, або LangSearch, Serper, Perplexity, Exa, Tavily, Linkup, SearchAPI з API-ключем).',
            calculatorLabel: 'Калькулятор (LaTeX / Math)',
            calculatorHint: 'Дозволити ШІ викликати вбудований калькулятор для точних математичних розрахунків та LaTeX формул.',
        ...
        ru: {
            ...
            tabFeatures: 'Настройки',
            tabThemes: 'Темы',
            settingsSearchPlaceholder: 'Искать в настройках',
            sectionGeneral: 'Общие',
            sectionGeneralDesc: 'Язык, горячие клавиши, расположение',
            sectionAutomation: 'Автоматизация и ответы',
            sectionAutomationDesc: 'Автоответ, подсветка, ограничения',
            sectionAiTools: 'Инструменты ИИ',
            sectionAiToolsDesc: 'Веб-поиск, калькулятор LaTeX',
            sectionStealth: 'Режим незаметности',
            sectionStealthDesc: 'Тихий режим, индикаторы, стелс',
            sectionAppearance: 'Оформление и стиль',
            sectionAppearanceDesc: 'Цвета, темы, система дизайна',
            providerLabel: 'Провайдер:',
            modelsLabel: 'Модели:',
            ...
            badgeMultimodal: 'Мультимодальная',
            badgeLongContext: 'Длинный контекст',
            badgeAgentic: 'Агентная',
            badgeAudio: 'Аудио ввод',
            badgeStructured: 'Структурированный вывод',
            badgeWebSearch: 'Веб-поиск',
            badgeMaxTokens: 'Макс. токенов',
            badgeCostInput: 'Ввод',
            ...
            webSearchHint: 'Разрешить ИИ искать в интернете актуальную информацию. Нужен поисковый провайдер во вкладке Провайдеры (SearXNG бесплатно, или LangSearch, Serper, Perplexity, Exa, Tavily, Linkup, SearchAPI с API-ключом).',
            calculatorLabel: 'Калькулятор (LaTeX / Math)',
            calculatorHint: 'Разрешить ИИ использовать встроенный калькулятор для точных математических расчетов и LaTeX формул.',
        ...
        en: {
            ...
            tabFeatures: 'Settings',
            tabThemes: 'Themes',
            settingsSearchPlaceholder: 'Search settings',
            sectionGeneral: 'General',
            sectionGeneralDesc: 'Language, hotkeys, positioning',
            sectionAutomation: 'Automation & Answers',
            sectionAutomationDesc: 'Auto-answer, highlighting, constraints',
            sectionAiTools: 'AI Tools',
            sectionAiToolsDesc: 'Web search, LaTeX calculator',
            sectionStealth: 'Stealth & Modes',
            sectionStealthDesc: 'Silent mode, indicators, stealth',
            sectionAppearance: 'Wallpaper & style',
            sectionAppearanceDesc: 'Colors, themes, design system',
            ...
            badgeMultimodal: 'Multimodal',
            badgeLongContext: 'Long context',
            badgeAgentic: 'Agentic',
            badgeAudio: 'Audio input',
            badgeStructured: 'Structured output',
            badgeWebSearch: 'Web search',
            badgeMaxTokens: 'Max tokens',
            ...
            webSearchHint: 'Enable AI to search the web for up-to-date information. Requires a search provider in the Providers tab (SearXNG is free, or LangSearch, Serper, Perplexity, Exa, Tavily, Linkup, SearchAPI with API key).',
            calculatorLabel: 'Calculator (LaTeX / Math)',
            calculatorHint: 'Allow AI to use built-in math calculator for precise evaluations and LaTeX formulas.',
